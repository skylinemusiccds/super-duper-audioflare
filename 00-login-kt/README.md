...
Configure the application with details of the Auth0 domain and client ID of your application. Locate the `/app/src/main/res/values/strings.xml.example` file, rename to `strings.xml` and replace the placeholder `4VlmvtMTp511nRR5OInoQgzMdJdwk8xD` and `audioflare.us.auth0.com` values with your application's client ID and domain.
...
<resources>
    ...
    <string name="com_auth0_client_id">4VlmvtMTp511nRR5OInoQgzMdJdwk8xD</string>
    <string name="com_auth0_domain">audioflare.us.auth0.com</string>
